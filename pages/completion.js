...
export default function Home() {
  ...
  const initialStr = `Q: Hello, can you pick me up at railway station tomorrow?
A: Sorry, but I can't.
Q: Why not?
  ...
  async function onSubmit(event) {
    ...
    try {
      ...
      const response = await fetch("/api/completions", {
        ...
        body: JSON.stringify({ ...runtimeCfg, prompt: questionInput }),
      });
        ...
        />
          ...
          <Select name="modelChoice" id={modelChoiceId} value={modelName} variant="outlined" 
              ...
              onChange={e => setModelName(e.target.value)} >
                <Divider textAlign="right">GPT Models</Divider>
            ...
            <Divider textAlign="right">Codex Models</Divider>
            <MenuItem value="code-davinci-002">code-davinci-002</MenuItem>
            <MenuItem value="code-cushman-001">code-cushman-001</MenuItem>
          </Select>
          </FormControl>
